...
/**
 * ibv_dmabuf_heap_cc_decrypted_init - Open the CoCo decrypted DMA-buf heap
 *
 * Shortcut for ibv_dmabuf_heap_init("system_cc_decrypted").
 */
 ...
 * @size: Requested buffer size in bytes (will be page-aligned)
